module FieldEnforcement
  module ClassMethods
    ...
    def gql_type
      return FieldEnforcement.processed_classes[self] if FieldEnforcement.processed_classes[self].present?
      ...
      FieldEnforcement.processed_classes[self] = type
    ...
    def enforce_declared_fields
      ...
      unless has_changes.nil?
        error_message = <<~STRING
          ...
          ----------------
        STRING
        raise Errors::FieldEnforcementMismatchError.new(error_message)
      end
    end
  end
